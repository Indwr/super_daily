 <div class="leftbar">
            ...
            <div class="sidebar">
                <!-- Start Logobar -->
                <div class="logobar">
                    <a href="dashboard.php" class="logo logo-large"><img src="<?php echo $set['logo'];?>" class="img-fluid" alt="logo"></a>
                    <a href="dashboard.php" class="logo logo-small"><img src="<?php echo $set['pdbanner'];?>" class="img-fluid" alt="logo"></a>
                </div>
                <!-- End Logobar -->
                <!-- Start Navigationbar -->
