            ...
            <div class="breadcrumbbar">
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-8">
                        ...
                        <div class="breadcrumb-list">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">List Deliveries</a></li>
					...
					<div class="col-md-4 col-lg-4">
                        <div class="widgetbar">
                            <a href="adddeliveries.php"><button class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>Add Deliveries</button></a>
                        </div>                        
                    </div>
                                ...
                                <div class="table-responsive">
									...
									<table id="data" class="display table  table-bordered dataTable dtr-inline" role="grid" aria-describedby="default-datatable_info">
                                        <thead>
											...
											<th >Deliveries Digit</th>
												<th>Deliveries Status</th>
												<th>Action</th>
									</tr>
                                        </thead>
                                        <tbody>
										<?php 
										$city = $mysqli->query("select * from tbl_delivery");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
												...
												<?php } ?>
                                                <td><a href="adddeliveries.php?deliveryid=<?php echo $row['id']; ?>" class="btn btn-info"><i class="fa fa-edit" ></i></a>
...
<script src="assets/modules/izitoast/js/iziToast.min.js"></script>
 ...
 iziToast.error({
    ...
    message: 'Deliveries Delete Successfully!!',
    position: 'topRight'
  });
  </script>
