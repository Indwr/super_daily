            ...
            <div class="breadcrumbbar">
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-8">
                        ...
                        <div class="breadcrumb-list">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">List Subcategory</a></li>
					...
					<div class="col-md-4 col-lg-4">
                        <div class="widgetbar">
                            <a href="addsub.php"><button class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>Add Subcategory</button></a>
                        </div>                        
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
									...
									<table id="data" class="display table  table-bordered dataTable dtr-inline" role="grid" aria-describedby="default-datatable_info">
                                        ...
                                        <tbody>
										<?php 
										$city = $mysqli->query("select * from tbl_subcat");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
												...
												<td> <?php $cdata = $mysqli->query("select * from tbl_cat where id=".$row['cid']."")->fetch_assoc(); echo $cdata['title']; ?></td>
												...
												<?php } ?>
                                                <td><a href="addsub.php?subcategoryid=<?php echo $row['id']; ?>" class="btn btn-info"><i class="fa fa-edit" ></i></a>
