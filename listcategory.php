            ...
            <div class="breadcrumbbar">
                <div class="row align-items-center">
					...
					<div class="col-md-4 col-lg-4">
                        <div class="widgetbar">
                            <a href="addcategory.php"><button class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>Add Category</button></a>
                        </div>                        
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
									...
									<table id="data" class="display table  table-bordered dataTable dtr-inline" role="grid" aria-describedby="default-datatable_info">
                                        ...
                                        <tbody>
										<?php 
										$city = $mysqli->query("select * from tbl_cat");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
												...
												<?php } ?>
                                                <td><a href="addcategory.php?categoryid=<?php echo $row['id']; ?>" class="btn btn-info"><i class="fa fa-edit" ></i></a>
