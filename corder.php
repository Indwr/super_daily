                    ...
                    <div class="col-md-8 col-lg-8">
                        ...
                        <div class="breadcrumb-list">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Cancelled Order</a></li>
                                ...
                                <div class="table-responsive">
									...
									<table id="data" class="display table table-bordered dataTable dtr-inline" role="grid" aria-describedby="default-datatable_info">
                                       <thead>
											...
											<?php 
											$i=0;
											 $stmt = $mysqli->query("SELECT * FROM `tbl_normal_order` where status='Cancelled'   order by id desc");
